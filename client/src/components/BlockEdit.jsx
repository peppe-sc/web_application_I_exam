...
function BlockEditForm(props) {
    ...
    function handleSubmit(event) {
        ...
        if (!text || text == 'Open this select menu') {
            ...
            setErrorMsg('Please insert a valid author name');
            return;
        }
        ...
        API.editBlock({id: blockid,type:type,content: text,page:block.page}).then(() => { setDirty(false); navigate('/backoffice/edit/' + pageid); }).catch((err) => { setErrorMsg(err.message); setDirty(false); });
